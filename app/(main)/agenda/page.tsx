...
const agenda = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        speaker: 'Dr. Jane Ruth Aceng Ocero, Minister for Health',
        icon: Mic,
        color: 'purple'
      },
      {
        time: '9:30 - 10:30',
        title: 'Keynote Address: Newborn Health & Global Health Systems',
        location: 'Main Auditorium',
        description: 'Dr. Queen Dube will offer invaluable insights into scalable, evidence-based interventions for small and sick newborns—and how frontline health professionals can shape the future of neonatal care.',
        speaker: 'Dr. Queen Dube, Newborn Health Program Lead, WHO Headquarters',
        icon: Mic,
        color: 'purple'
      },
      {
        time: '14:00 - 16:00',
        title: 'AHF Monday Side Event',
        location: 'Conference Hall A',
        description: 'AIDS Healthcare Foundation side event focusing on HIV/AIDS prevention and treatment strategies',
        speaker: 'Dr. Wilson, Session Chair - AHF',
        icon: Users,
        color: 'green'
      },
      {
  ...
  },
  {
    ...
    events: [
      ...
      {
        time: '14:00 - 15:00',
        title: 'Roundtable Discussion: Ministry of Health and Centers of HIV Excellence',
        location: 'Main Auditorium',
        description: 'High-level discussion between Ministry of Health Leadership and key HIV/AIDS organizations including UAC, JCRC, TASO, AIC, Baylor College, AHF/Uganda Cares and MJAP',
        speaker: 'Ministry of Health Leadership (P.S & D.G), UAC, JCRC, TASO, AIC, Baylor College, AHF/Uganda Cares, MJAP',
        icon: Users,
        color: 'purple'
      },
      {
    ...
    events: [
      {
        ...
        location: 'Main Auditorium',
        description: 'Special guest presentation on health systems and policy development',
        speaker: 'Prof. Omaswa, Guest Speaker',
        icon: Mic,
        color: 'purple'
      },
      {
