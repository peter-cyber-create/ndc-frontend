          ...
          <form className="flex-1 flex flex-col gap-5 bg-white border border-primary-200 rounded-2xl p-6 shadow-md" onSubmit={handleSubmit} noValidate>
            ...
            <div className="flex flex-col gap-2">
              <AnimatedInput
                ...
                label="Name *"
                glitchEffect={true}
                className="rounded-lg px-4 py-2 bg-white text-primary-900"
            ...
            <div className="flex flex-col gap-2">
              <AnimatedTextarea
                ...
                label="Message *"
                glitchEffect={true}
                className="rounded-lg px-4 py-2 bg-white text-primary-900 resize-none"
            ...
            <AnimatedButton
              ...
              className="mt-2 px-8 py-3 rounded-xl font-bold text-base"
            >
