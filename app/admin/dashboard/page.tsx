    ...
    try {
      ...
      if (dashboardResponse.ok) {
        ...
        const dashboardStats: DashboardData = {
          registrations: {
            total: dashboardData.stats?.registrations?.total || 0,
            approved: dashboardData.stats?.registrations?.approved || 0,
            submitted: dashboardData.stats?.registrations?.pending || 0,
            underReview: 0,
            rejected: dashboardData.stats?.registrations?.rejected || 0,
            newThisWeek: dashboardData.stats?.registrations?.newThisWeek || 0
          },
          abstracts: {
            total: dashboardData.stats?.abstracts?.total || 0,
            approved: dashboardData.stats?.abstracts?.approved || 0,
            submitted: dashboardData.stats?.abstracts?.pending || 0,
            underReview: 0,
            accepted: dashboardData.stats?.abstracts?.approved || 0,
            rejected: dashboardData.stats?.abstracts?.rejected || 0,
            newThisWeek: dashboardData.stats?.abstracts?.newThisWeek || 0
          },
          contacts: {
            total: dashboardData.stats?.contacts?.total || 0,
            submitted: dashboardData.stats?.contacts?.pending || 0,
            underReview: 0,
            responded: dashboardData.stats?.contacts?.responded || 0,
            requiresFollowup: 0,
            newThisWeek: dashboardData.stats?.contacts?.newThisWeek || 0
          },
          sponsorships: {
            total: dashboardData.stats?.sponsorships?.total || 0,
            submitted: dashboardData.stats?.sponsorships?.pending || 0,
            underReview: 0,
            approved: dashboardData.stats?.sponsorships?.approved || 0,
            negotiating: 0
          }
        }
