...
export default function AbstractsPage() {
  ...
  const loadAbstracts = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/admin/abstracts`)
  ...
  const handleDownload = async (fileUrl: string, abstract: Abstract) => {
    try {
      ...
      const authorName = abstract.author ? abstract.author.replace(/[^a-zA-Z0-9]/g, '_') : 'Unknown'
              ...
              {filteredAbstracts.map((abstract) => (
                <tr key={abstract.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div>
                      <div className="text-sm font-medium text-gray-900">{getAuthorName(abstract.author)}</div>
                      <div className="text-sm text-gray-500">{abstract.email}</div>
                      <div className="text-xs text-gray-400">{abstract.organization}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
            ...
            <div className="space-y-4 max-h-[70vh] overflow-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="text-base text-gray-900">{getAuthorName(selected.author)}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-base text-gray-900">{selected.organization || '—'}</div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <div className="text-base text-gray-900">{selected.category || '—'}</div>
                </div>
                <div>
