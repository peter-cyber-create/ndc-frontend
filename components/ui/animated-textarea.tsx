...
const AnimatedTextarea = React.forwardRef<HTMLTextAreaElement, AnimatedTextareaProps>(
  ({ className, label, error, glitchEffect = false, typingEffect = false, ...props }, ref) => {
      ...
      <div className="relative w-full group">
        ...
        <div className="relative">
          <textarea
            ref={ref}
            className={cn(
              "peer w-full min-h-[120px] px-3 pt-6 pb-2 text-base bg-transparent border-0 border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:ring-0 transition-all duration-200 ease-out resize-none",
              // Glitch effect
